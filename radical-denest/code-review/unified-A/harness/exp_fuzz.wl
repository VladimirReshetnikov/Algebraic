...
runFamily[name_, gen_, n_] := Module[{stats = <||>, tmax = 0, ttot = 0, bad = {}, input, t, res, msgs, c, k},
  Do[
   ...
   If[c === "WRONGVALUE" || c === "timeout" || c === "nonnumeric", AppendTo[bad, {input, res, c, msgs}]],
   {n}];
  Print["FAMILY ", name, "  n=", n, "  total ", Round[ttot, 0.01], "s  max ", Round[tmax, 0.01], "s"];
  Print["   ", stats];
  Do[Print["   BAD: ", ToString[b[[1]], InputForm], "  ->  ", ToString[b[[2]], InputForm], "  ", b[[3]], " ", b[[4]]], {b, Take[bad, Min[8, Length[bad]]]}];
...
Put[results, "C:/Users/vresh/AppData/Local/Temp/claude/C--RadicalDenest--claude-worktrees-strad-denesting-analysis-6158e6/8331ac58-d8d2-4638-b75d-79549acb84bf/scratchpad/exp_fuzz_results.m"];
Print["DONE"];
