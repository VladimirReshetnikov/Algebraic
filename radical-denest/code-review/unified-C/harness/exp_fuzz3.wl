...
AppendTo[results, runFamily["F11 Sqrt[(Sqrt[a]+Sqrt[b]+Sqrt[c])^2] three surds", Function[{}, Module[{abc = RandomSample[sqf3, 3], s = RandomChoice[{-1, 1}, 3]}, Sqrt[Expand[(s . Sqrt[abc])^2]]]], 30]];
AppendTo[results, runFamily["F12 ((p+q Sqrt[c])^5)^(1/5)", Function[{}, Module[{p = rnz[], q = rnz[], c = RandomChoice[sqf]}, Expand[(p + q Sqrt[c])^5]^(1/5)]], 25]];
AppendTo[results, runFamily["F13 ((p+q Sqrt[c])^7)^(1/7)", Function[{}, Module[{p = rnz[], q = rnz[], c = RandomChoice[sqf]}, Expand[(p + q Sqrt[c])^7]^(1/7)]], 20]];
AppendTo[results, runFamily["F14 ((p+q Sqrt[c])^6)^(1/6)", Function[{}, Module[{p = rnz[], q = rnz[], c = RandomChoice[sqf]}, Expand[(p + q Sqrt[c])^6]^(1/6)]], 15]];
Put[results, "C:/Users/vresh/AppData/Local/Temp/claude/C--RadicalDenest--claude-worktrees-strad-denesting-analysis-6158e6/8331ac58-d8d2-4638-b75d-79549acb84bf/scratchpad/exp_fuzz3_results.m"];
Print["DONE"];
