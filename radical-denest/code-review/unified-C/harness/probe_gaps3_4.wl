...
Print["Factorc[radicand] = ", ToString[RadicalDenest3`Factorc[First[s05]], InputForm]];
Print["Factorc[problem]  = ", ToString[RadicalDenest3`Factorc[s05], InputForm]];
...
Print["Factorc[radicand]:        ", AbsoluteTiming[tc[RadicalDenest3`Factorc[First[p13]]]] /. e_ /; LeafCount[e] > 40 :> Short[e]];
Print["Factorc[problem]:         ", AbsoluteTiming[tc[RadicalDenest3`Factorc[p13]]] /. e_ /; LeafCount[e] > 40 :> Short[e]];
Print["DenestCore, m=1 only:     ", AbsoluteTiming[tc[RadicalDenest3`DenestCore[p13, "Multipliers" -> {1}]]]];
Print["DenestCore, default:      ", AbsoluteTiming[tc[RadicalDenest3`DenestCore[p13, "MaxTrials" -> 3, "TimeBudget" -> 10]]]];
...
Print["four primes, Factorc[radicand]: ", AbsoluteTiming[tc[RadicalDenest3`Factorc[First[p4]]]][[1]]];
Print["four primes, DenestCore m=1:    ", AbsoluteTiming[tc[RadicalDenest3`DenestCore[p4, "Multipliers" -> {1}]]]];
