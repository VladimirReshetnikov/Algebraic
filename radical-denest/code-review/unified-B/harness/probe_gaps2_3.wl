...
inspect[id_, problem_, r_] := Module[{x, rho, mp, g, roots, cands},
  ...
  Print["   contain Root objects: ", ! FreeQ[roots, _Root], "   RadicalCost of roots: ", RadicalDenest2`RadicalCost /@ roots];
...
Print["Factorc[radicand] = ", ToString[RadicalDenest2`Factorc[First[r15]], InputForm]];
