...
\item \emph{Implementation} (Section~\ref{sec:impl}).  The Galois group is computed by numerical
  ...
  computes the full splitting-field data in three to five seconds, against about twenty seconds in
  the Wolfram kernel.
\end{enumerate}
...
\bottomrule
\end{tabular}
\caption{Wall-clock times (Wolfram 15.0.1; Python 3.14 with python-flint 0.8 and SymPy 1.14).  The regression suites (39 Wolfram tests, 18 Python checks) pass.}\label{tab:timing}
\end{table}
